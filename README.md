...
Currently, most of optimized additional syntax highlighting groups are coming from [rhysd/vim-color-spring-night](https://github.com/rhysd/vim-color-spring-night#optimized-filetypes-and-plugins), which I think may not be completely suitable for this color scheme.

If you want to optimize the syntax highlighting of a filetype, please feel free to fork it, any PR is welcome.
